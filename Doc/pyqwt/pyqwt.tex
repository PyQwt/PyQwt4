...
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.17.2.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.17.2-gpl.tar.gz}}
...
\begin{notice}[note]
  You can install PyQwt-4.2.3 compiled for Qt3 side by side with PyQwt5
