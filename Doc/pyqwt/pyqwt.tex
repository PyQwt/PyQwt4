...
\newcommand{\NumPyTarGz}{\ulink{NumPy-1.0b5.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0b5.tar.gz?download}}
...
\begin{enumerate}
  \item
    ...
    Supported versions: Python-2.4.x, and -2.3.x.
  \item
