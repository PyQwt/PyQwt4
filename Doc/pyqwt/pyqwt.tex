...
\newcommand{\Sip}{\ulink{sip-4.4.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.4.tar.gz}}
...
\newcommand{\NumPyTarGz}{\ulink{NumPy-0.9.6.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-0.9.6.tar.gz?download}}
