...
\newcommand{\Sip}{\ulink{sip-4.5.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.5.tar.gz}}
\newcommand{\SipSnapShot}{\ulink{SIP snapshot}
  {http://www.riverbankcomputing.com/Downloads/Snapshots/sip4/}}
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.17.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.17-gpl.tar.gz}}
\newcommand{\PyQtMac}{\ulink{PyQt-mac-gpl-3.17.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-3.17.tar.gz}}
...
\newcommand{\NumPyTarGz}{\ulink{NumPy-1.0.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0.tar.gz?download}}
...
\newcommand{\PrerequisitesEnd}{
  ...
  \NumPy{} is actively developed and recommended for new users.
...
\begin{itemize}
\item
  subsection \ref{iqt-intro} describing the module \module{Qwt4.iqt} which
  facilitates the use of PyQt and PyQwt from the command line interpreter.
\item
  subsection \ref{intro-qplt-plot} describes the module \module{Qwt4.qplt}
