...
\newcommand{\Sip}{\ulink{sip-4.5.2.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.5.2.tar.gz}}
...
\newcommand{\NumPyTarGz}{\ulink{NumPy-1.0.1.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0.1.tar.gz?download}}
